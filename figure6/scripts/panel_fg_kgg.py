...
# The five terms of the published panel g. FDR >= this counts as not significant.
...
# 2.05 in, down from 2.6: the Venn carried more area than its three numbers
# need, and shrinking it lets the coverage panel beside it grow.
...
if overlap is not None:
    overlap.set_color('#9E6E9E')     # the two hues mixed, for the shared wedge
...
# Colorbars are drawn as an image by default; keep it vector so Illustrator does
# not resample it (the same problem that hit the figure 2a matrix).
