...
# matplotlib's default `pad_inches` for bbox_inches='tight', per side. Named here
# because the height fit has to subtract it — see fit_saved_height_inches.
PAD_IN = 0.1

# ---------------------------------------------------------------------------
# Protein-group sets per channel.
# ---------------------------------------------------------------------------
...
for region_id in ('100', '010', '001', '110', '101', '011', '111'):
    ...
    # The three-set region is dark enough that black numbers stop reading.
...
# ---------------------------------------------------------------------------
# Source data — every region of the Venn.
# ---------------------------------------------------------------------------
rows = []
for ch in CHANNELS:
