...
from _core.py (REFACTOR_PLAN.md step 2); behaviour unchanged."""
...
def group_proteins_by_signature(
    ...
    """
    # For each protein, collect the (frozen) set of peptide accession-sets
    # it appears in. Each unique frozenset is one group.
    accession_set_keys = []
