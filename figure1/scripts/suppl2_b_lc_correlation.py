"""Supplementary figure 2b — protein-group agreement between the two LC front ends (H032_E333)."""
import os
import sys
import numpy as np
import pandas as pd
...
def main():
    ...
    fig.tight_layout()
    core.set_axes_size_inches(fig, ax, w_in=AXES_H_IN, h_in=AXES_H_IN)
